...
<head>
    ...
    <title>Mini / Pleasure Driving Entry Form</title>
  ...
  <div class="wholeForm">
    ...
    <table class="formTable text-center">
      ...
      <tbody>
        ...
        <tr>
          <td>
            <div><br></div>
            <h1 class="heading1">Mini / Pleasure Driving Entry Form</h1>
            <div><br></div>
            <div><br></div>
    ...
    <form action="" method="post">
          ...
          <table class="formTable text-center entryInfo">
            ...
            <tbody>
              ...
              <tr> 
                <td class="row mb-3">
                    <label for="exInsuranceInp" class="col-sm-2 col-form-label textFieldLbl">Exhibitors NSEF # <bold class="star">*</bold></label>
                </td>
                ...
                <td class="row mb-3">
                    <label for="horseNameInp" class="col-sm-2 col-form-label textFieldLbl">Equine Name</label>
                  </td>

                  <td class="col-sm-4">
                      <input type="text" class="form-control textFieldInp" id="horseNameInp" placeholder="Horse Name">
                </td>
              ...
              <tr>
                  <div><br></div>   
                  <td class="row mb-3">
                    <label for="hnd2FnameInp" class="col-sm-2 col-form-label textFieldLbl">Handler 2 First Name</label>
                  </td>

                  <td class="col-sm-4">
                      <input type="text" class="form-control textFieldInp" id="hnd2FnameInp" placeholder="First Name">
                </td>

                  <td class="row mb-3">
                    <label for="hnd2LnameInp" class="col-sm-2 col-form-label textFieldLbl">Handler 2 Last Name </label>
                  </td>
                  <td class="col-sm-4">
                      <input type="text" class="form-control txtFieldInp" id="hand2LnameInp" placeholder="Last Name">
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="row mb-3">
                    <label for="hand2InsuranceInp" class="col-sm-2 col-form-label numFieldLbl">Handler 2 NSEF # </label>
                </td>

                <td class="col-sm-4">
                      <input type="text" class="form-control numFieldInp" id="hand2InsuranceInp" placeholder="Insurance ">
                </td>
            </tr>
    ...
    <table class="formTable text-center entryInfo">
        ...
        <tbody>
            ...
            <tr>  
                <td class="col1">
                <label for="arivalDaySlt" class="col-sm-5 col-form-label textFieldLbl " id="arrivalDayLbl">Arrival Day <bold class="star">*</bold></label>
                </td>
                
                <td class="col2">
                <select class="form-select dropdown textFieldInp" id="arivalDaySlt" aria-label="Default select example">
                ...
                <td class="col1">
                    <label for="departDaySlt" class="col-sm-5 col-form-label textFieldLbl " id="departDayLbl">Departure Day <bold class="star">*</bold></label>
                    </td>
                    
                    <td class="col2">
                    <select class="form-select dropdown textFieldInp" id="departDaySlt" aria-label="Default select example">
                        <option selected>Select Day</option>
                        <option value="Sunday"></option>
                        <option value="Monday"></option>
                        <option value="Tuesday"></option>
