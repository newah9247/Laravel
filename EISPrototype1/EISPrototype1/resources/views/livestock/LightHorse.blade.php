...
<head>
    ...
    <title>Light Horse Entry Form</title>
  ...
  <div class="wholeForm">
    ...
    <table class="formTable text-center">
      ...
      <tbody>
        ...
        <tr>
          <td>
            <div><br></div>
            <h1 class="heading1">Light Horse Entry Form</h1>
            <div><br></div>
            <div><br></div>
          ...
          <table class="formTable text-center entryInfo">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <div><br></div>   
                  <td class="row mb-3">
                    <label for="horseNameInp" class="col-sm-2 col-form-label textFieldLbl">Horse Name</label>
                  </td>
                ...
                <td class="row mb-3">
                    <label for="ownInsuranceInp" class="col-sm-2 col-form-label numFieldLbl">Owners NSEF # </label>
                </td>
              ...
              <tr>
                  <div><br></div>   
                <td class="row mb-3">
                  <label for="horseNameInp" class="col-sm-2 col-form-label textFieldLbl">MBRA #</label>
                </td>
                ...
                <td class="row mb-3">
                  <label for="isExOwnerChk" >Is the exhibitior the owner? <bold class="star">*</bold></label>
                </td>
                    
                <td>
                  <div style="display: inline-block">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input entriesRadio" type="radio" name="yes"  value="Yes">
                        <label class="form-check-label entriesLbl" for="yes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input entriesRadio" type="radio" name="no" value="No">
                        <label class="form-check-label entriesLbl" for="no">No</label>
                    </div>
                  </div>
                </td>
              </tr>
    ...
    <table class="formTable text-center entryInfo">
      ...
      <tbody>
          ...
          <tr>  
              <td class="col1">
              <label for="arivalDaySlt" class="col-sm-5 col-form-label priceLbl " id="arrivalDayLbl">Arrival Day <bold class="star">*</bold></label>
              </td>
              
              <td class="col2">
              <select class="form-select dropdown" id="arivalDaySlt" aria-label="Default select example">
              ...
              <td class="col1">
                  <label for="departDaySlt" class="col-sm-5 col-form-label priceLbl " id="departDayLbl">Departure Day <bold class="star">*</bold></label>
                  </td>
                  
                  <td class="col2">
                  <select class="form-select dropdown" id="departDaySlt" aria-label="Default select example">
                      <option selected>Select Day</option>
                      <option value="Sunday"></option>
                      <option value="Monday"></option>
                      <option value="Tuesday"></option>
