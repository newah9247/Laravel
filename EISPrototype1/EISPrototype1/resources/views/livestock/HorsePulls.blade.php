...
<head>
    ...
    <title>Horse Pulls Entry Form</title>
  ...
  <div class="wholeForm">
      ...
      <table class="formTable text-center">
        ...
        <tbody>
          <tr>
            <td>
              <div><br></div>
              <h1 class="heading1">Horse Pulls Entry Form</h1>
              <div><br></div>
              <div><br></div>
    ...
    <form action="" method="post">
      <div class="container text-center">
          ...
          <div class="entryOption" style="display: inline-block; vertical-align: top;">
            <label for="pullEntries" style="margin-right: 20px">Pull Entries: <bold class="star">*</bold></label>
          </div>
          <div style="display: inline-block">

          <div class="form-check form-check-inline">
              <input class="form-check-input entriesRadio" type="radio" name="pullEntries"  value="week">
              <label class="form-check-label entriesLbl" for="pullEntries">Exhibiting for the Week</label>
            </div>

            <div class="form-check form-check-inline">
              <input class="form-check-input entriesRadio" type="radio" name="pullEntriesFriday" value="friday">
              <label class="form-check-label entriesLbl" for="pullEntriesFriday">Friday Pulls Only</label>
            </div>
          </div>
      </div>
      <div><br></div>
      ...
      <table>
        ...
        <tr>
          <td class="col1">
            <label for="headFee" class="col-sm-5 col-form-label priceLbl">Number of Horses<bold class="star">*</bold></label>
          </td>
          ...
          <td rowspan="15" class="col4">
            <h5 class="text-center"><bold>Exhibiting for the week includes a 1 Week Pass</bold></h5>
            <div><br></div>

            <h5 class="text-center"><bold>Exhibiting for Friday pulls includes 2 day Passes</bold></h5>
            <div><br></div>
            ...
            <h8> e-transfers ONLY accepted at: manager@annapolisvalleyexhibition.com <br>
              Please include Entry Name in Notes for identification.</h8>
            <div><br></div>
